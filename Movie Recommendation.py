...
# %%
movies = pd.read_csv(r'D:\Bharat intern movie recomendation\\movies.csv')
genome_scores = pd.read_csv(r'D:\Bharat intern movie recomendation\\links.csv')
tags = pd.read_csv(r'D:\Bharat intern movie recomendation\\tags.csv')
genome_tags = pd.read_csv(r'D:\Bharat intern movie recomendation\\links.csv')
ratings = pd.read_csv(r'D:\Bharat intern movie recomendation\\ratings.csv')
